...
function Server(config) {
    ...
    // do this for functions which can be called out this scope.
    self.init = init;
    ...
    function authenticateUser(data, callback) {
        var body = data.data;
        // firebase username cannot contain spl characters
        body.username = body.username.replace(/[^a-zA-Z0-9 ]/g, "");
